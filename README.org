...
(no-leader
"C-0"   '(harpoon-go-to-9  :which-key "workspace 0")
"C-1"   '(harpoon-go-to-0  :which-key "workspace 1")
"C-2"   '(harpoon-go-to-1  :which-key "workspace 2")
"C-3"   '(harpoon-go-to-2  :which-key "workspace 3")
"C-4"   '(harpoon-go-to-3  :which-key "workspace 4")
"C-5"   '(harpoon-go-to-4  :which-key "workspace 5")
"C-6"   '(harpoon-go-to-5  :which-key "workspace 6")
"C-7"   '(harpoon-go-to-6  :which-key "workspace 7")
"C-8"   '(harpoon-go-to-7  :which-key "workspace 8")
"C-9"   '(harpoon-go-to-8  :which-key "workspace 9")
)
